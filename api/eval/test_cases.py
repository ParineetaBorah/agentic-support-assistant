...
TEST_CASES: list[dict] = [
    ...
    },
    {
        ...
        "user": "bob",
        "expected_tools": ["get_customer_profile", "get_open_issues", "get_issue_detail"],
        "expected_grounded": True,
        "expected_outcome": "success",
    },
    {
        ...
        "user": "bob",
        "expected_tools": ["get_customer_profile", "create_escalation_summary"],
        "expected_grounded": True,
        "expected_outcome": "success",
    },
    {
        ...
        "user": "carol",
        "expected_tools": ["get_customer_profile", "create_next_action"],
        "expected_grounded": True,
        "expected_outcome": "success",
    },
    {
    ...
    },
    {
        ...
        "user": "bob",
        "expected_tools": ["get_customer_profile", "add_issue_update"],
        "expected_grounded": True,
        "expected_outcome": "success",
    },
]
